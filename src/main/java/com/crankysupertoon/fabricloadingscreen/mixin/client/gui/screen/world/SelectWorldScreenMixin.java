...
import com.crankysupertoon.fabricloadingscreen.client.gui.screen.world.SelectWorldScreenExtension;
...
public abstract class SelectWorldScreenMixin extends Screen implements SelectWorldScreenExtension {
    ...
    private Screen modifyOpenScreen(Screen original) {
        if (FabricLoadingScreenClient.rememberNewWorldSettingsEnabled) {
    ...
    public void developermode_openOrCreateLevel(String name) {
        try {
            ...
            FabricLoadingScreen.LOGGER.error("Failed to auto load world", e);
        }
    }
}
